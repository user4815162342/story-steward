...
AppInfo = {
	...
	Version: {
		 ...
		 */
		Build: Number(fileUtil.readFile(scriptPath + "build-number.txt").replace(/^\s*/, "").replace(/\s*$/, "")),
		/* 
...
logger.info("Working with: " + AppInfo.Title + " " + AppInfo.Version.Major + "." + AppInfo.Version.Minor + "." + AppInfo.Version.Build + "." + AppInfo.Version.Revision);
